...
- Worker створює демонстраційне спостереження для кожного поста під час
  першого запуску та оновлює показники раз на 5 хвилин. Реальні показники
  можна передавати через endpoint спостережень.
